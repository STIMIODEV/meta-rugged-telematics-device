SUMMARY = "Access 4G Internet Connection from SIM in Telematics Device"
DESCRIPTION = "Recipe to support access 4G Internet Connection from SIM in Telematics Device"
LICENSE = "CLOSED"
