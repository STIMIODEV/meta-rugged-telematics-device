SUMMARY = "Services for Telematics Device"
DESCRIPTION = "Recipe to copy Services for Telematics Device"
LICENSE = "CLOSED"

FILES:${PN} = "${sysconfdir} ${bindir} ${systemd_unitdir}"
...
SYSTEMD_SERVICE:${PN} = "${@bb.utils.contains('DISTRO_FEATURES', 'systemd', ' ble.service restart_ble.service sshd.service watchdog.service wifi_enable.service ', '', d)}"
